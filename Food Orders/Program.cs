...
namespace Project1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("_____________________________________________________________________________________________");
            Console.WriteLine("You would like " + userBreakfast + ", for the day");
            Console.WriteLine("You would like " + userLunch + ", for the day");
            Console.WriteLine("You would like " + userDinner + ", for the day");
